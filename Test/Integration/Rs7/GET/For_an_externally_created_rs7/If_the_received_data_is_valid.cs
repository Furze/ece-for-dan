...
namespace MoE.ECE.Integration.Tests.Rs7.GET.For_an_externally_created_rs7
{
    public class If_the_received_data_is_valid : SpeedyIntegrationTestBase
    {
        ...
        protected If_the_received_data_is_valid(RunOnceBeforeAllTests testSetUp, ITestOutputHelper output, TestState<ECEStoryBook, ECEStoryData> testState) : base(testSetUp, output, testState)
        {
        }
