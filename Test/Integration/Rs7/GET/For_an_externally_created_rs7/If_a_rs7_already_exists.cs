...
namespace MoE.ECE.Integration.Tests.Rs7.GET.For_an_externally_created_rs7
{
    public class If_a_rs7_already_exists : SpeedyIntegrationTestBase
    {
        ...
        public If_a_rs7_already_exists(RunOnceBeforeAllTests testSetUp, ITestOutputHelper output,
        ...
        protected override void Act() => When.Get($"{Url}/{ExternallyReceivedRs7.Id}");

        [Fact]
        public void Then_the_response_should_be_ok() => Then.Response.ShouldBe.Ok<Rs7Model>();
        ...
        public void ExpectDomainEventShouldHavePopulatedEntitlementMonthFromTheCommand()
        {
            ...
            Rs7EntitlementDayModel? entitlementDay = entitlementMonth?.Days?.FirstOrDefault();
        ...
        [Fact]
        public void ExpectAnRs7UpdatedIntegrationEventRaised() => An_integration_event_should_be_fired<Rs7Updated>();
    }
}