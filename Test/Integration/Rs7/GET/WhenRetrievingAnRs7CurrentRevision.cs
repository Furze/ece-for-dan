...
namespace MoE.ECE.Integration.Tests.Rs7.GET
{
    public class WhenRetrievingAnRs7CurrentRevision : SpeedyIntegrationTestBase
    {
        ...
        public WhenRetrievingAnRs7CurrentRevision(RunOnceBeforeAllTests testSetUp, ITestOutputHelper output, TestState testState) : base(testSetUp, output, testState)
        {
        }
