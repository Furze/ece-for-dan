...
namespace MoE.ECE.Integration.Tests.Rs7.PUT.WhenUpdatingAnRs7ZeroReturn
{
    ...
    {
        protected IfTheOrganisationLicenceIsCancelled(RunOnceBeforeAllTests testSetUp, ITestOutputHelper output,
        ...
        protected override void Arrange()
        {
            Given
                .A_rs7_zero_return_has_been_created(rs7 =>
                    rs7.OrganisationId = ReferenceData.EceServices.FamilyTiesEducare.RefOrganisationId)
