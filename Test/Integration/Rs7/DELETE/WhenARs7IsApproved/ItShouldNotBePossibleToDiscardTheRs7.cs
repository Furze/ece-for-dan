...
namespace MoE.ECE.Integration.Tests.Rs7.DELETE.WhenARs7IsApproved
{
    public class ItShouldNotBePossibleToDiscardTheRs7 : SpeedyIntegrationTestBase
    {
        ...
        [Fact]
        public void ThenADomainEventShouldNotBeFired() => A_domain_event_should_not_be_fired<Rs7Discarded>();
    }
}