...
{
    public class ForAnOrganisationThatIsFundedMonthly : IntegrationTestBase<ECEStoryBook, ECEStoryData>
    {
        private Guid _businessEntityId;

        public ForAnOrganisationThatIsFundedMonthly(RunOnceBeforeAllTests testSetUp, ITestOutputHelper output,
        ...
        protected override void Arrange() =>
            Given
                .A_rs7_skeleton_has_been_created(rs7 =>
                    {
                        rs7.OrganisationId = ReferenceData.EceServices.PorseMarlboroughHomebasedNetwork.RefOrganisationId;
        ...
        public void Then_the_business_exceptions_should_not_be_empty()
        {
            ...
            response.First().BusinessExceptions?.ShouldContain(model => model.Key == ServiceMonthlyFundingBusinessException.MonthlyFundingKey);
        }
