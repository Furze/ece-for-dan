...
{
    public class ForAnOrganisationExistingRequest : SpeedyIntegrationTestBase
    {
        public ForAnOrganisationExistingRequest(RunOnceBeforeAllTests testSetUp, ITestOutputHelper output,
            TestState<ECEStoryBook, ECEStoryData> testState) : base(testSetUp, output, testState)
        {
        }

        private const string BusinessEntityId = "C8EE3A99-1994-44E4-94E1-AB222589F1AC";
        private const int RevisionNumber = 0;
