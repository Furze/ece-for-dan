...
namespace MoE.ECE.Domain.Read.Model.Rs7
{
    ...
    {
        [ReadOnly(true)] public Guid? BusinessEntityId { get; set; }

        [ReadOnly(true)] public int? OrganisationId { get; set; }

        [ReadOnly(true)]
        [JsonConverter(typeof(JsonNoEnumConverter<FundingPeriodMonth>))]
        public FundingPeriodMonth FundingPeriod { get; set; }

        [ReadOnly(true)] public int FundingYear { get; set; }

        [ReadOnly(true)] public int FundingPeriodYear { get; set; }
        ...
        [ReadOnly(true)] public int RevisionNumber { get; set; }

        [ReadOnly(true)] public DateTimeOffset RevisionDate { get; set; }
