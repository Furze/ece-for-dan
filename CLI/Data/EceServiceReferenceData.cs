...
namespace MoE.ECE.CLI.Data
{
    ...
    public class EceServiceReferenceData
    {
                ...
                return new[]
                {
                    new EceService
                    {
                        ...
                        OperatingSessions = new List<EceOperatingSession>
                        {
                            ...
                            new EceOperatingSession
                            {
                                SessionDayId = 325088, SessionDayDescription = "Tuesday", MaxChildren = 35,
                                MaxChildrenUnder2 = 8,
                                SessionTypeId = 25000, SessionTypeDescription = "All Day",
                                SessionProvisionTypeId = 24001, SessionProvisionTypeDescription = "Teacher Led",
                                FundedHours = 6,
        ...
        public EceService MontessoriLittleHands => Data.Single(service => service.OrganisationNumber == MontessoriOrganisationNumber);
        public EceService TestClosedService => Data.Single(service => service.OrganisationNumber == TestClosedServiceOrganisationNumber);
        public EceService FamilyTiesEducare => Data.Single(service => service.OrganisationNumber == FamilyTiesOrganisationNumber);
        public EceService NurtureMe2 => Data.Single(service => service.OrganisationNumber == NurtureMe2OrganisationNumber);

        public EceService GetByType(int organisationTypeId)
        {
            return Data.First(service => service.OrganisationTypeId == organisationTypeId);
        }
        
        public EceService Get(int organisationTypeId, int licenceClassId)
        {
            return Data.First(service => service.OrganisationTypeId == organisationTypeId && service.LicenceClassId == licenceClassId);
        }
    }
} 